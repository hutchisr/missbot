...
- `hindsight_user_profile_max_tokens` (default `384`): maximum generated size of each compact profile. The profile prompt also enforces a conservative word target; internal evidence retrieval independently uses `hindsight_recall_max_tokens`
